...
ipv4_value=$(sysctl -n net.ipv4.conf.all.send_redirects)
...
if $success_1 && $success_2; then
    echo "Network configuration for TWGCB-01-008-0109 has been completed."
else
    echo "Network configuration for TWGCB-01-008-0109 has failed."
fi
